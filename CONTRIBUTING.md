# How to contribute to  cozy-linshare?
...
- What is the version of the  cozy-linshare app?
...
```
$ git clone github.com/cozy/ cozy-linshare.git
$ cd  cozy-linshare
$ git remote add fork git://github.com/yourusername/ cozy-linshare.git
```
...
Go to https://github.com/yourusername/ cozy-linshare and select your branch. Click the 'Pull Request' button and fill out the form.
...
The  cozy-linshare is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/cozy/ cozy-linshare/issues/new
...
[localization]: https://github.com/cozy/ cozy-linshare/blob/master/README.md#localization
